    ...
    <section className="flex flex-col lg:flex-row items-center justify-between py-12 px-6 lg:px-24">
      ...
      <ul className="space-y-4">
        ...
        <li className="flex items-center text-gray-700">
          ...
          Second Floor, D-82 JS Plaza, Janpath, Shyam Nagar, Jaipur, Rajasthan, India 302019
        </li>
        ...
        {/* Phone */}
        <li onClick={handleCall} className="flex items-center text-gray-700 cursor-pointer">
      ...
      <div className="mt-6 flex space-x-4">
        <a href="https://www.linkedin.com/in/asliarpit/" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="text-2xl text-blue-700 hover:text-blue-800 transition-all" />
        </a>
        <a href="https://www.instagram.com/trendsupmedia" target="_blank" rel="noopener noreferrer">
          <FaInstagram className="text-2xl text-pink-600 hover:text-pink-700 transition-all" />
        </a>
        <a href="https://www.facebook.com/trendsupmedia" target="_blank" rel="noopener noreferrer">
          <FaFacebook className="text-2xl text-blue-600 hover:text-blue-700 transition-all" />
        </a>
        <a href="https://www.youtube.com/@trendsupmedia" target="_blank" rel="noopener noreferrer">
